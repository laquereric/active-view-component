  ...
  class Generator
    ...
    class Page
      ...
      class Html
        class << self
          def generate(options = {})
            ActiveViewComponent::Core::ViewBlockNode.new.tap do |node|
          ...
          def default_page_node(options = {})
            ...
            ActiveViewComponent::Core::ViewBlockNode.new.tap do |node|
              ...
              node.children = [
                ...
                ActiveViewComponent::Core::ViewBlockNode.new.tap do |head|
                  ...
                  head.children = [
                    ActiveViewComponent::Core::ViewBlockNode.new.tap do |meta|
                ...
                ActiveViewComponent::Core::ViewBlockNode.new.tap do |body|
