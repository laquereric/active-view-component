...
RSpec.describe ActiveViewComponent::Components::Page::Body::Component, type: :component do
  describe "basic rendering" do
    it "renders body element" do
      render_inline(ActiveViewComponent::Generator::Page::Html::Body.create_component) do
        "Body content"
      end
  ...
  describe "with body class" do
    ...
    it "applies CSS classes" do
      render_inline(ActiveViewComponent::Generator::Page::Html::Body.create_component(body_class: body_class))
  ...
  describe "with data attributes" do
    ...
    it "applies data attributes" do
      render_inline(ActiveViewComponent::Generator::Page::Html::Body.create_component(data_attributes: data_attributes))
  ...
  describe "with both class and data attributes" do
    ...
    it "applies both class and data attributes" do
      render_inline(ActiveViewComponent::Generator::Page::Html::Body.create_component(
